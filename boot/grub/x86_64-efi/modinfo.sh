...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 12.2.1 20230111'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/12.2.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_package_version="2:2.06.r440.g4de39a2af-1"
